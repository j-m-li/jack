...
#define JACK_Ship_H
var Ship__new();
var Ship__getX(var __this);
var Ship__getY(var __this);
var Ship__dispose(var __this);
var Ship__draw(var __this);
var Ship__erase(var __this);
var Ship__moveLeft(var __this);
var Ship__moveRight(var __this);
var Ship__fireBullet(var __this);
var Ship__getBullet(var __this);
#endif
...
#ifndef JACK_SpaceGame_H
#define JACK_SpaceGame_H
var SpaceGame__new();
var SpaceGame__makeEnemies(var __this);
var SpaceGame__hitEnemy(var __this, var b);
var SpaceGame__bulletHitEnemy(var __this, var en, var b);
var SpaceGame__moveEnemies(var __this);
var SpaceGame__dispose(var __this);
var SpaceGame__mod(var __this, var t, var a);
var SpaceGame__run(var __this);
var SpaceGame__moveSquare(var __this);
var SpaceGame__trackBullet(var __this, var b);
var SpaceGame__createMissile(var __this, var en);
var SpaceGame__chooseEnemy(var __this);
var SpaceGame__moveMissile(var __this);
var SpaceGame__died(var __this);
var SpaceGame__destroyMissile(var __this);
var SpaceGame__missileHitShip(var __this);
#endif
...
#ifndef JACK_Bullet_H
#define JACK_Bullet_H
var Bullet__new(var startX);
var Bullet__getY(var __this);
var Bullet__getX(var __this);
var Bullet__dispose(var __this);
var Bullet__draw(var __this);
var Bullet__fire(var __this);
#endif
...
#ifndef JACK_Enemy_H
#define JACK_Enemy_H
var Enemy__new(var startx, var starty, var startsize);
var Enemy__draw(var __this);
var Enemy__dispose(var __this);
var Enemy__getX(var __this);
var Enemy__getY(var __this);
var Enemy__getIsDead(var __this);
var Enemy__getDirection(var __this);
var Enemy__changeDirection(var __this);
var Enemy__moveX(var __this);
var Enemy__moveY(var __this);
var Enemy__moveXNeg(var __this);
#endif
...
#ifndef JACK_EnemyBullet_H
#define JACK_EnemyBullet_H
var EnemyBullet__new(var startX);
var EnemyBullet__dispose(var __this);
var EnemyBullet__getY(var __this);
var EnemyBullet__getX(var __this);
var EnemyBullet__draw(var __this, var isTrue);
var EnemyBullet__fire(var __this);
#endif
...
#define width__ (__this+3)
#define bullet__ (__this+4)
var Ship__new() {
	var __this;
...
var Ship__draw(var __this) {
	Screen__setColor(-1);
	Screen__drawRectangle(__peek(x__), __peek(y__), __peek(x__)+__peek(size__)+__peek(width__), __peek(y__)+__peek(size__));
	return 0;
}
var Ship__erase(var __this) {
	Screen__setColor(0);
...
var Ship__moveRight(var __this) {
	if (0!=(((((__peek(x__)+__peek(size__)))<(470))?-1:0))) {
		Screen__setColor(0);
		Screen__drawRectangle(__peek(x__), __peek(y__), __peek(x__)+__peek(size__)+__peek(width__), __peek(y__)+__peek(size__));
		__poke(x__, __peek(x__)+2);
		Screen__setColor(-1);
...
var Ship__fireBullet(var __this) {
	var temp = 0;
	temp = (__peek(size__)+__peek(width__))/2;
	__poke(bullet__, Bullet__new(__peek(x__)+temp));
	return 0;
}
var Ship__getBullet(var __this) {
	return __peek(bullet__);
}
#undef x__
#undef y__
#undef size__
...
#ifdef JACK_IMPLEMENTATION
var SpaceGame___str0[] = {83,67,79,82,69,58,32,0};
var SpaceGame___str1[] = {32,32,32,32,32,32,76,69,86,69,76,58,32,0};
var SpaceGame___str2[] = {32,32,32,32,32,32,76,73,86,69,83,58,32,0};
var SpaceGame___str3[] = {83,67,79,82,69,58,32,0};
var SpaceGame___str4[] = {32,32,32,32,32,32,76,69,86,69,76,58,32,0};
var SpaceGame___str5[] = {32,32,32,32,32,32,76,73,86,69,83,58,32,0};
var SpaceGame___str6[] = {89,111,117,32,104,97,118,101,32,100,105,101,100,33,32,68,111,32,121,111,117,32,119,105,115,104,32,116,111,32,114,101,115,116,97,114,116,63,0};
var SpaceGame___str7[] = {89,111,117,32,107,105,108,108,101,100,32,0};
var SpaceGame___str8[] = {32,101,110,101,109,105,101,115,0};
var SpaceGame___str9[] = {76,101,102,116,32,102,111,114,32,121,101,115,32,47,32,82,105,103,104,116,32,102,111,114,32,110,111,0};
var SpaceGame___str10[] = {83,67,79,82,69,58,32,0};
var SpaceGame___str11[] = {32,32,32,32,32,32,76,69,86,69,76,58,32,0};
var SpaceGame___str12[] = {32,32,32,32,32,32,76,73,86,69,83,58,32,0};
var SpaceGame___str13[] = {83,67,79,82,69,58,32,0};
var SpaceGame___str14[] = {32,32,32,32,32,32,76,69,86,69,76,58,32,0};
var SpaceGame___str15[] = {32,32,32,32,32,32,76,73,86,69,83,58,32,0};
#define square__ (__this+0)
#define direction__ (__this+1)
#define isBullet__ (__this+2)
#define enemies__ (__this+3)
#define enemiesDead__ (__this+4)
#define numEnemies__ (__this+5)
#define time__ (__this+6)
#define level__ (__this+7)
#define score__ (__this+8)
#define enBullet__ (__this+9)
#define numEnB__ (__this+10)
#define isEnBullet__ (__this+11)
#define lives__ (__this+12)
#define enemySize__ (__this+13)
#define ss__ (__this+14)
#define ssx__ (__this+15)
#define ssy__ (__this+16)
#define ouch__ (__this+17)
#define enemyToFire__ (__this+18)
var SpaceGame__new() {
	var __this;
	__this = Memory__alloc(19);
	__poke(square__, Ship__new());
	__poke(direction__, 0);
	__poke(isBullet__, 0);
	__poke(enemiesDead__, 0);
	__poke(numEnemies__, 10);
	__poke(enemies__, Array__new(__peek(numEnemies__)));
	__poke(score__, 0);
	__poke(time__, 0);
	__poke(level__, 0);
	__poke(numEnB__, 0);
	__poke(isEnBullet__, 0);
	__poke(enemySize__, 10);
	__poke(ss__, 10);
	__poke(ssx__, 50);
	__poke(ssy__, 10);
	__poke(enemyToFire__, 0);
	SpaceGame__makeEnemies(__this);
	__poke(lives__, 3);
	return __this;
}
var SpaceGame__makeEnemies(var __this) {
	...
	y = 50;
	c = 0;
	while (-1==((((c)<(__peek(numEnemies__)))?-1:0))) {
		e = Enemy__new(x, y, __peek(enemySize__));
		__poke(__peek(enemies__)+c, e);
		x = x+20;
		c = c+1;
	}
	return 0;
...
var SpaceGame__hitEnemy(var __this, var b) {
	...
	c = 0;
	while (-1==((((c)<(__peek(numEnemies__)))?-1:0))) {
		en = __peek(__peek(enemies__)+c);
		i = SpaceGame__bulletHitEnemy(__this, en, b);
		if (0!=((((i)==(1))?-1:0))) {
			Enemy__dispose(en);
			__poke(enemiesDead__, __peek(enemiesDead__)+1);
			__poke(score__, __peek(score__)+1);
			Output__moveCursor(0, 0);
			Output__printString(Memory__getString(SpaceGame___str0));
			Output__printInt(__peek(score__));
			Output__printString(Memory__getString(SpaceGame___str1));
			Output__printInt(__peek(level__));
			Output__printString(Memory__getString(SpaceGame___str2));
			Output__printInt(__peek(lives__));
			if (0!=((((__peek(enemiesDead__))==(__peek(numEnemies__)))?-1:0))) {
				__poke(level__, __peek(level__)+1);
				Memory__deAlloc(__peek(enemies__));
				__poke(enemies__, Array__new(__peek(numEnemies__)));
				SpaceGame__makeEnemies(__this);
				__poke(enemiesDead__, 0);
			}
...
var SpaceGame__bulletHitEnemy(var __this, var en, var b) {
	...
	bx = Bullet__getX(b);
	enx = Enemy__getX(en);
	if (0!=((~((((by)<(eny))?-1:0)))&(~((((by)>((eny+__peek(enemySize__))))?-1:0))))) {
		if (0!=((~((((bx)<(enx))?-1:0)))&(~((((bx)>((enx+__peek(enemySize__))))?-1:0))))) {
			return 1;
		}
...
var SpaceGame__moveEnemies(var __this) {
	...
	c = 0;
	found = 0;
	while (-1==(((((c)<(__peek(numEnemies__)))?-1:0))&~found)) {
		temp_en = __peek(__peek(enemies__)+c);
		dead = Enemy__getIsDead(temp_en);
		if (0!=((((dead)==(0))?-1:0))) {
			enL = temp_en;
			found = 1;
		}
	...
	enrx = Enemy__getX(enR);
	enlx = Enemy__getX(enL);
	eny = Enemy__getY(enL);
	dir = Enemy__getDirection(enL);
	atLeft = 0;
	atRight = 0;
	atBottom = 1;
	if (0!=((((enlx)<(20))?-1:0))) {
...
var SpaceGame__run(var __this) {
	...
	exit = 0;
	Output__moveCursor(0, 0);
	Output__printString(Memory__getString(SpaceGame___str3));
	Output__printInt(__peek(score__));
	Output__printString(Memory__getString(SpaceGame___str4));
	Output__printInt(__peek(level__));
	Output__printString(Memory__getString(SpaceGame___str5));
	Output__printInt(__peek(lives__));
	while (-1==(~exit)) {
		__poke(time__, __peek(time__)+1);
		while (-1==((((key)==(0))?-1:0))) {
			if (0!=((((__peek(time__))==(299))?-1:0))) {
				SpaceGame__chooseEnemy(__this);
			}

			SpaceGame__moveMissile(__this);
			__poke(time__, __peek(time__)+1);
			key = Keyboard__keyPressed();
			SpaceGame__moveSquare(__this);
			timeMod = SpaceGame__mod(__this, __peek(time__), 60);
			if (0!=((((timeMod)==(0))?-1:0))) {
				SpaceGame__moveEnemies(__this);
			}

			if (0!=((((__peek(isBullet__))==(1))?-1:0))) {
				b = Ship__getBullet(__peek(square__));
				Bullet__fire(b);
				SpaceGame__trackBullet(__this, b);
				didHit1 = SpaceGame__hitEnemy(__this, b);
				if (0!=((((didHit1)==(1))?-1:0))) {
					Bullet__dispose(b);
					__poke(isBullet__, 0);
				}
		...
		if (0!=((((key)==(1))?-1:0))) {
			Screen__clearScreen();
			Output__moveCursor(0, 0);
			Output__printString(Memory__getString(SpaceGame___str6));
			Output__moveCursor(10, 0);
			Output__printString(Memory__getString(SpaceGame___str7));
			Output__printInt(__peek(score__));
			Output__printString(Memory__getString(SpaceGame___str8));
			Output__moveCursor(20, 0);
			Output__printString(Memory__getString(SpaceGame___str9));
			key = Keyboard__keyPressed();
			while (-1==((((key)==(0))?-1:0))) {
				key = Keyboard__keyPressed();
			}
			if (0!=((((key)==(130))?-1:0))) {
				...
				__poke(level__, 0);
				Output__moveCursor(0, 0);
				Output__printString(Memory__getString(SpaceGame___str10));
				Output__printInt(__peek(score__));
				Output__printString(Memory__getString(SpaceGame___str11));
				Output__printInt(__peek(level__));
				Output__printString(Memory__getString(SpaceGame___str12));
				Output__printInt(__peek(lives__));
			} else {
				exit = -1;
				key = 81;
		...
		if (0!=((((key)==(32))?-1:0))) {
			...
			SpaceGame__moveMissile(__this);
			if (0!=((((__peek(isBullet__))==(0))?-1:0))) {
				__poke(time__, __peek(time__)+1);
				Ship__fireBullet(__peek(square__));
				__poke(isBullet__, 1);
			}
		...
		while (-1==(~((((key)==(0))?-1:0)))) {
			...
			key = Keyboard__keyPressed();
			SpaceGame__moveSquare(__this);
			timeMod = SpaceGame__mod(__this, __peek(time__), 15);
			if (0!=((((timeMod)==(0))?-1:0))) {
				SpaceGame__moveEnemies(__this);
			}
			...
			if (0!=((((__peek(isBullet__))==(1))?-1:0))) {
				...
				Bullet__fire(b);
				SpaceGame__trackBullet(__this, b);
				didHit2 = SpaceGame__hitEnemy(__this, b);
				if (0!=((((didHit2)==(1))?-1:0))) {
					Bullet__dispose(b);
					__poke(isBullet__, 0);
				}
...
var SpaceGame__moveSquare(var __this) {
	if (0!=((((__peek(direction__))==(3))?-1:0))) {
		Ship__moveLeft(__peek(square__));
	}

	if (0!=((((__peek(direction__))==(4))?-1:0))) {
		Ship__moveRight(__peek(square__));
	}

	return 0;
}
var SpaceGame__trackBullet(var __this, var b) {
	if (0!=((((Bullet__getY(b))<(11))?-1:0))) {
		__poke(isBullet__, 0);
		Bullet__dispose(b);
	}
...
var SpaceGame__createMissile(var __this, var en) {
	var enx = 0;
	enx = Enemy__getX(en);
	__poke(enBullet__, EnemyBullet__new(enx));
	__poke(isEnBullet__, 1);
	return 0;
}
var SpaceGame__chooseEnemy(var __this) {
	var c = 0;
	...
	var enx = 0;
	var dead = 0;
	if (0!=((((__peek(isEnBullet__))==(0))?-1:0))) {
		c = 0;
		while (-1==((((c)<(__peek(numEnemies__)))?-1:0))) {
			en = __peek(__peek(enemies__)+c);
			dead = Enemy__getIsDead(en);
			if (0!=((((dead)==(0))?-1:0))) {
				SpaceGame__createMissile(__this, en);
			}
...
var SpaceGame__moveMissile(var __this) {
	var my = 0;
	var key = 0;
	if (0!=((((__peek(isEnBullet__))==(1))?-1:0))) {
		EnemyBullet__fire(__peek(enBullet__));
		__poke(ouch__, SpaceGame__missileHitShip(__this));
		if (0!=((((__peek(ouch__))==(1))?-1:0))) {
		}

		my = EnemyBullet__getY(__peek(enBullet__));
		if (0!=((((my)>(249))?-1:0))) {
			SpaceGame__destroyMissile(__this);
		}
...
var SpaceGame__destroyMissile(var __this) {
	if (0!=((((__peek(isEnBullet__))==(1))?-1:0))) {
		EnemyBullet__dispose(__peek(enBullet__));
		__poke(isEnBullet__, 0);
	}
...
var SpaceGame__missileHitShip(var __this) {
	...
	var bs = 0;
	var sSize = 0;
	by = EnemyBullet__getY(__peek(enBullet__));
	sy = Ship__getY(__peek(square__));
	bx = EnemyBullet__getX(__peek(enBullet__));
	sx = Ship__getX(__peek(square__));
	bs = 4;
	if (0!=((((__peek(isEnBullet__))==(1))?-1:0))) {
		if (0!=((((((bx)>(sx))?-1:0))&((((by)>(sy))?-1:0))&((((bx)<((sx+__peek(ssx__))))?-1:0))&((((by)<((sy+__peek(ssy__))))?-1:0)))|((((((bx+bs))>(sx))?-1:0))&((((by)>(sy))?-1:0))&(((((bx+bs))<((sx+__peek(ssx__))))?-1:0))&((((by)<((sy+__peek(ssy__))))?-1:0)))|(((((bx)>(sx))?-1:0))&(((((by+bs))>(sy))?-1:0))&((((bx)<((sx+__peek(ssx__))))?-1:0))&(((((by+bs))<((sy+__peek(ssy__))))?-1:0)))|((((((bx+bs))>(sx))?-1:0))&(((((by+bs))>(sy))?-1:0))&(((((bx+bs))<((sx+__peek(ssx__))))?-1:0))&(((((by+bs))<((sy+__peek(ssy__))))?-1:0))))) {
			SpaceGame__destroyMissile(__this);
			__poke(lives__, __peek(lives__)-1);
			Output__moveCursor(0, 0);
			Output__printString(Memory__getString(SpaceGame___str13));
			Output__printInt(__peek(score__));
			Output__printString(Memory__getString(SpaceGame___str14));
			Output__printInt(__peek(level__));
			Output__printString(Memory__getString(SpaceGame___str15));
			Output__printInt(__peek(lives__));
			return 1;
		}
...
#define y__ (__this+1)
#define size__ (__this+2)
#define isDead__ (__this+3)
#define direction__ (__this+4)
var Enemy__new(var startx, var starty, var startsize) {
	var __this;
	__this = Memory__alloc(5);
	__poke(size__, startsize);
	__poke(x__, startx);
	__poke(y__, starty);
	__poke(direction__, 1);
	__poke(isDead__, 0);
	Enemy__draw(__this);
	return __this;
}
...
var Enemy__moveX(var __this) {
	if (0!=((((__peek(isDead__))==(0))?-1:0))) {
		Screen__setColor(0);
		Screen__drawRectangle(__peek(x__), __peek(y__), __peek(x__)+__peek(size__), __peek(y__)+__peek(size__));
		__poke(x__, __peek(x__)+10);
		Screen__setColor(-1);
		Screen__drawRectangle(__peek(x__), __peek(y__), __peek(x__)+__peek(size__), __peek(y__)+__peek(size__));
	}
...
var EnemyBullet__draw(var __this, var isTrue) {
	...
	if (0!=(((((__peek(x__))>(0))?-1:0))&((((__peek(y__))>(0))?-1:0))&(((((__peek(x__)+__peek(size__)))<(510))?-1:0))&(((((__peek(y__)+__peek(size__)))<(253))?-1:0)))) {
		Screen__drawRectangle(__peek(x__), __peek(y__), __peek(x__)+__peek(size__), __peek(y__)+__peek(size__));
	}
...
var EnemyBullet__fire(var __this) {
	EnemyBullet__draw(__this, 0);
	__poke(y__, __peek(y__)+2);
	EnemyBullet__draw(__this, 1);
	return 0;
}
#undef x__
#undef y__
