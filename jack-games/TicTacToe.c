...
#ifndef JACK_X_H
#define JACK_X_H
var X__draw_x(var xcor, var ycor);
var X__draw(var num);
#endif
...
#ifndef JACK_Board_H
#define JACK_Board_H
var Board__new(var x, var y);
var Board__build(var __this);
var Board__fill_numbers(var __this);
var Board__dispose(var __this);
#endif
...
#define JACK_Main_H
var Main__main();
var Main__Checkwinner(var arr, var i);
var Main__article();
#endif
...
#ifdef JACK_IMPLEMENTATION
var X__draw_x(var xcor, var ycor) {
	Screen__drawLine(xcor+20, ycor+10, xcor+74, ycor+30);
	Screen__drawLine(xcor+76, ycor+10, xcor+20, ycor+30);
	Screen__drawLine(xcor+20, ycor+12, xcor+74, ycor+32);
	Screen__drawLine(xcor+76, ycor+12, xcor+20, ycor+32);
	Screen__drawLine(xcor+20, ycor+11, xcor+74, ycor+31);
	Screen__drawLine(xcor+76, ycor+11, xcor+20, ycor+31);
	return 0;
}
var X__draw(var num) {
	if (0!=((((num)==(1))?-1:0))) {
		Output__moveCursor(13, 22);
		Output__moveCursor(6, 0);
		X__draw_x(128, 128);
	}

	if (0!=((((num)==(2))?-1:0))) {
		Output__moveCursor(13, 34);
		Output__moveCursor(6, 0);
		X__draw_x(224, 128);
	}

	if (0!=((((num)==(3))?-1:0))) {
		Output__moveCursor(13, 45);
		Output__moveCursor(6, 0);
		X__draw_x(320, 128);
	}

	if (0!=((((num)==(4))?-1:0))) {
		Output__moveCursor(17, 22);
		Output__moveCursor(6, 0);
		X__draw_x(128, 168);
	}
	...
	if (0!=((((num)==(6))?-1:0))) {
		Output__moveCursor(17, 45);
		Output__moveCursor(6, 0);
		X__draw_x(320, 168);
	}

	if (0!=((((num)==(7))?-1:0))) {
		Output__moveCursor(20, 22);
		Output__moveCursor(6, 0);
		X__draw_x(128, 208);
	}
...
#ifdef JACK_IMPLEMENTATION
#define xcordinate__ (__this+0)
#define ycordinate__ (__this+1)
var Board__new(var x, var y) {
	var __this;
	__this = Memory__alloc(2);
	__poke(xcordinate__, x);
	__poke(ycordinate__, y);
	Board__build(__this);
	Board__fill_numbers(__this);
	return __this;
}
var Board__build(var __this) {
	Screen__drawLine(__peek(xcordinate__), __peek(ycordinate__), __peek(xcordinate__)+288, __peek(ycordinate__));
	Screen__drawLine(__peek(xcordinate__), __peek(ycordinate__), __peek(xcordinate__), __peek(ycordinate__)+120);
	Screen__drawLine(__peek(xcordinate__)+288, __peek(ycordinate__), __peek(xcordinate__)+288, __peek(ycordinate__)+120);
	Screen__drawLine(__peek(xcordinate__), __peek(ycordinate__)+120, __peek(xcordinate__)+288, __peek(ycordinate__)+120);
	Screen__drawLine(__peek(xcordinate__)+96, __peek(ycordinate__), __peek(xcordinate__)+96, __peek(ycordinate__)+120);
	Screen__drawLine(__peek(xcordinate__)+192, __peek(ycordinate__), __peek(xcordinate__)+192, __peek(ycordinate__)+120);
	Screen__drawLine(__peek(xcordinate__), __peek(ycordinate__)+40, __peek(xcordinate__)+288, __peek(ycordinate__)+40);
	Screen__drawLine(__peek(xcordinate__), __peek(ycordinate__)+80, __peek(xcordinate__)+288, __peek(ycordinate__)+80);
	return 0;
}
var Board__fill_numbers(var __this) {
	Output__moveCursor(13, 22);
...
var O__draw(var n) {
	if (0!=((((n)==(1))?-1:0))) {
		Screen__drawCircle(176, 148, 18);
		Screen__setColor(0);
		Screen__drawCircle(176, 148, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(2))?-1:0))) {
		Screen__drawCircle(272, 148, 18);
		Screen__setColor(0);
		Screen__drawCircle(272, 148, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(3))?-1:0))) {
		Screen__drawCircle(368, 148, 18);
		Screen__setColor(0);
		Screen__drawCircle(368, 148, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(4))?-1:0))) {
		Screen__drawCircle(176, 188, 18);
		Screen__setColor(0);
		Screen__drawCircle(176, 188, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(5))?-1:0))) {
		Screen__drawCircle(272, 188, 18);
		Screen__setColor(0);
		Screen__drawCircle(272, 188, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(6))?-1:0))) {
		Screen__drawCircle(368, 188, 18);
		Screen__setColor(0);
		Screen__drawCircle(368, 188, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(7))?-1:0))) {
		Screen__drawCircle(176, 228, 18);
		Screen__setColor(0);
		Screen__drawCircle(176, 228, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(8))?-1:0))) {
		Screen__drawCircle(272, 228, 18);
		Screen__setColor(0);
		Screen__drawCircle(272, 228, 15);
		Screen__setColor(-1);
	}

	if (0!=((((n)==(9))?-1:0))) {
		Screen__drawCircle(368, 228, 18);
		Screen__setColor(0);
		Screen__drawCircle(368, 228, 15);
		Screen__setColor(-1);
	}
...
#ifdef JACK_IMPLEMENTATION
var Main___str0[] = {80,108,97,121,101,114,32,49,44,99,104,111,111,115,101,32,97,32,110,117,109,98,101,114,32,98,101,116,119,101,101,110,32,49,45,57,58,32,0};
var Main___str1[] = {80,108,97,121,101,114,32,49,44,80,108,101,97,115,101,32,115,101,108,101,99,116,32,108,101,103,97,108,32,110,117,109,98,101,114,58,32,0};
var Main___str2[] = {80,108,97,121,101,114,32,49,32,119,111,110,33,0};
var Main___str3[] = {79,111,112,115,33,32,84,104,101,114,101,32,105,115,32,110,111,32,119,105,110,110,101,114,0};
var Main___str4[] = {80,108,97,121,101,114,32,50,44,99,104,111,111,115,101,32,97,32,110,117,109,98,101,114,32,98,101,116,119,101,101,110,32,49,45,57,58,32,0};
var Main___str5[] = {80,108,97,121,101,114,32,50,44,80,108,101,97,115,101,32,115,101,108,101,99,116,32,108,101,103,97,108,32,110,117,109,98,101,114,58,32,0};
var Main___str6[] = {80,108,97,121,101,114,32,50,32,119,111,110,33,0};
var Main___str7[] = {87,101,108,99,111,109,101,32,84,111,32,84,105,99,32,84,97,99,32,84,111,101,32,33,0};
var Main__main() {
	var counter = 0;
	var board = 0;
	var arr = 0;
	...
	var n = 0;
	var i = 0;
	board = Board__new(128, 128);
	arr = Array__new(10);
	flag = -1;
	counter = 0;
	Main__article();
	while (-1==(flag)) {
		n = Keyboard__readInt(Memory__getString(Main___str0));
		i = 0;
		while (-1==((((i)<(50))?-1:0))) {
			Output__moveCursor(6, i);
			i = i+1;
		}
		Output__moveCursor(6, 0);
		while (-1==(((((__peek(arr+n))==(1))?-1:0))|((((__peek(arr+n))==(-1))?-1:0))|((((n)<(1))?-1:0))|((((n)>(9))?-1:0)))) {
			n = Keyboard__readInt(Memory__getString(Main___str1));
			i = 0;
			while (-1==((((i)<(60))?-1:0))) {
				Output__moveCursor(6, i);
				i = i+1;
		...
		counter = counter+1;
		X__draw(n);
		if (0!=((((Main__Checkwinner(arr, 1))==(0))?-1:0))) {
			Output__printString(Memory__getString(Main___str2));
			flag = 0;
		}

		if (0!=(((((counter)==(9))?-1:0))&(flag))) {
			Output__printString(Memory__getString(Main___str3));
			Array__dispose(arr);
			Board__dispose(board);
			return 0;
		}

		if (0!=(flag)) {
			n = Keyboard__readInt(Memory__getString(Main___str4));
			i = 0;
			while (-1==((((i)<(50))?-1:0))) {
				Output__moveCursor(6, i);
				i = i+1;
			...
			Output__moveCursor(6, 0);
			while (-1==(((((__peek(arr+n))==(1))?-1:0))|((((__peek(arr+n))==(-1))?-1:0))|((((n)<(1))?-1:0))|((((n)>(9))?-1:0)))) {
				n = Keyboard__readInt(Memory__getString(Main___str5));
				i = 0;
				while (-1==((((i)<(60))?-1:0))) {
					Output__moveCursor(6, i);
					i = i+1;
...
var Main__Checkwinner(var arr, var i) {
	if (0!=(((((__peek(arr+1))==(i))?-1:0))&((((__peek(arr+2))==(i))?-1:0))&((((__peek(arr+3))==(i))?-1:0)))) {
		Screen__drawLine(128, 128+20, 128+288, 128+20);
		return 0;
	}

	if (0!=(((((__peek(arr+4))==(i))?-1:0))&((((__peek(arr+5))==(i))?-1:0))&((((__peek(arr+6))==(i))?-1:0)))) {
		Screen__drawLine(128, 128+60, 128+288, 128+60);
		return 0;
	}

	if (0!=(((((__peek(arr+7))==(i))?-1:0))&((((__peek(arr+8))==(i))?-1:0))&((((__peek(arr+9))==(i))?-1:0)))) {
		Screen__drawLine(128, 128+100, 128+288, 128+100);
		return 0;
	}

	if (0!=(((((__peek(arr+1))==(i))?-1:0))&((((__peek(arr+4))==(i))?-1:0))&((((__peek(arr+7))==(i))?-1:0)))) {
		Screen__drawLine(128+48, 128, 128+48, 128+120);
		return 0;
	}

	if (0!=(((((__peek(arr+2))==(i))?-1:0))&((((__peek(arr+5))==(i))?-1:0))&((((__peek(arr+8))==(i))?-1:0)))) {
		Screen__drawLine(128+144, 128, 128+144, 128+120);
		return 0;
	}

	if (0!=(((((__peek(arr+3))==(i))?-1:0))&((((__peek(arr+6))==(i))?-1:0))&((((__peek(arr+9))==(i))?-1:0)))) {
		Screen__drawLine(128+240, 128, 128+240, 128+120);
		return 0;
	}

	if (0!=(((((__peek(arr+1))==(i))?-1:0))&((((__peek(arr+5))==(i))?-1:0))&((((__peek(arr+9))==(i))?-1:0)))) {
		Screen__drawLine(128, 128, 128+288, 128+120);
		return 0;
	}

	if (0!=(((((__peek(arr+3))==(i))?-1:0))&((((__peek(arr+5))==(i))?-1:0))&((((__peek(arr+7))==(i))?-1:0)))) {
		Screen__drawLine(128, 128+120, 128+288, 128);
		return 0;
	}
